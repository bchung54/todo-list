...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "body {\n    height: 100vh;\n    display: flex;\n    align-items: stretch;\n    overflow-y:hidden;\n}\n\n.sidebar {\n    background-color: #7b1800;\n    width: 450px;\n    overflow-x: hidden;\n    transition: 0.5s;\n}\n\n.sidebar-item {\n    font-size: 28px;\n    color: #aaa5a5;\n    display: block;\n    transition: 0.3s;\n    padding: 10px 50px;\n    border-bottom: #315a83 4px solid;\n}\n\n.sidebar-item:hover {\n    color: #efe74a;\n    background-color: #3184C6;\n}\n\n.sidebar-title {\n    background-color: #BC1828;\n    color: #ddd2d2;\n    padding: 10px;\n    font-size: 40px;\n}\n\n.main {\n    background-color: #6BB5E7;\n    width: 100%;\n    padding: 50px;\n}\n\n.project-container {\n    padding: 5px 26px;\n}\n\n.project-title {\n    font-size: 40px;\n}\n\n.project-list-item {\n    display: flex;\n    justify-content: space-between;\n    font-size: 28px;\n}\n\n.project-list-item:hover {\n    border: #ffc552 2px solid;\n}\n\n.labels-container {\n    display: flex;\n}", "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,aAAa;IACb,oBAAoB;IACpB,iBAAiB;AACrB;;AAEA;IACI,yBAAyB;IACzB,YAAY;IACZ,kBAAkB;IAClB,gBAAgB;AACpB;;AAEA;IACI,eAAe;IACf,cAAc;IACd,cAAc;IACd,gBAAgB;IAChB,kBAAkB;IAClB,gCAAgC;AACpC;;AAEA;IACI,cAAc;IACd,yBAAyB;AAC7B;;AAEA;IACI,yBAAyB;IACzB,cAAc;IACd,aAAa;IACb,eAAe;AACnB;;AAEA;IACI,yBAAyB;IACzB,WAAW;IACX,aAAa;AACjB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,eAAe;AACnB;;AAEA;IACI,yBAAyB;AAC7B;;AAEA;IACI,aAAa;AACjB","sourcesContent":["body {\n    height: 100vh;\n    display: flex;\n    align-items: stretch;\n    overflow-y:hidden;\n}\n\n.sidebar {\n    background-color: #7b1800;\n    width: 450px;\n    overflow-x: hidden;\n    transition: 0.5s;\n}\n\n.sidebar-item {\n    font-size: 28px;\n    color: #aaa5a5;\n    display: block;\n    transition: 0.3s;\n    padding: 10px 50px;\n    border-bottom: #315a83 4px solid;\n}\n\n.sidebar-item:hover {\n    color: #efe74a;\n    background-color: #3184C6;\n}\n\n.sidebar-title {\n    background-color: #BC1828;\n    color: #ddd2d2;\n    padding: 10px;\n    font-size: 40px;\n}\n\n.main {\n    background-color: #6BB5E7;\n    width: 100%;\n    padding: 50px;\n}\n\n.project-container {\n    padding: 5px 26px;\n}\n\n.project-title {\n    font-size: 40px;\n}\n\n.project-list-item {\n    display: flex;\n    justify-content: space-between;\n    font-size: 28px;\n}\n\n.project-list-item:hover {\n    border: #ffc552 2px solid;\n}\n\n.labels-container {\n    display: flex;\n}"],"sourceRoot":""}]);
// Exports
...
const todo = (0,_todo_item_js__WEBPACK_IMPORTED_MODULE_2__["default"])("Create webpage", [2022, 2, 20], 2, ['school', 'work', 'play'], "All my life");
todo.setDueDate(2022, 2, 23);
const todo2 = (0,_todo_item_js__WEBPACK_IMPORTED_MODULE_2__["default"])("Download more RAM");
const todo3 = (0,_todo_item_js__WEBPACK_IMPORTED_MODULE_2__["default"])("Play Solitaire");
